...
/**
 * @author bjsonghongxu
 * @create 2018-05-17 15:35
 **/
public class QrCodeCreateUtil extends LuminanceSource {
    public static final Logger logger = LoggerFactory.getLogger(QrCodeCreateUtil.class);
    // 二维码颜色
    ...
    public QrCodeCreateUtil(BufferedImage image) {
        this(image, 0, 0, image.getWidth(), image.getHeight());
    }

    public QrCodeCreateUtil(BufferedImage image, int left, int top, int width, int height) {
        super(width, height);
    ...
    public LuminanceSource crop(int left, int top, int width, int height) {
        return new QrCodeCreateUtil(image, this.left + left, this.top + top, width, height);
    }
    ...
    public LuminanceSource rotateCounterClockwise() {
        ...
        g.dispose();
        int width = getWidth();
        return new QrCodeCreateUtil(rotatedImage, top, sourceWidth - (left + width), getHeight(), width);
    }
     ...
     * @throws Exception
     */
    public static boolean generateQRCode(String content, int width, int height, String format, OutputStream outputStream){
        boolean rs = false;
        try {
    ...
    public static String parseQRCode(String filePath) {
        ...
        try {
            ...
            LuminanceSource source = new QrCodeCreateUtil(image);
    ...
    public static void main(String[] args) {
        String text = "https://www.baidu.com"; // 随机生成验证码
